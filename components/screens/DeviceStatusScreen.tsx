...
const statusRows = [
  ...
  { icon: Bluetooth, label: "Bluetooth", value: "Connected", tone: "text-blue-400" },
  { icon: Mic, label: "Mic Status", value: "Active", tone: "text-emerald-400" },
  { icon: SlidersHorizontal, label: "ANC Status", value: "Medium", tone: "text-white/80" },
    ...
    <div className="flex h-full flex-col px-4 py-4">
      ...
      <div className="mt-5 grid gap-2">
        {statusRows.map((row) => (
          ...
          >
            <row.icon size={17} className="shrink-0 text-blue-500" />
